    ...
    >
        ...
        {anySelected && (
            <div className="d-flex align-items-center me-3" style={{ gap: '0.5rem' }}>
                ...
                <Button size="sm" variant="outline-primary" onClick={onBulkCopy}>
                    Copy
                </Button>
                <Button size="sm" variant="outline-primary" onClick={onBulkMove}>
                    Move
                </Button>
        ...
        {/* Main controls: search, add, import, columns */}
        <div className="d-flex align-items-center ms-auto" style={{ gap: '0.75rem' }}>
            ...
            {/* Import CSV */}
            <Button size="sm" variant="outline-primary" onClick={onImportCsv}>
                Import CSV
            </Button>
